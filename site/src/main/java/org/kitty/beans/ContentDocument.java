...
@HippoEssentialsGenerated(internalName = "kittyshippoproject:contentdocument")
@Node(jcrType = "kittyshippoproject:contentdocument")
public class ContentDocument extends BaseDocument {
    ...
    public String getIntroduction() {
        return getProperty("kittyshippoproject:introduction");
    }
    ...
    public Calendar getPublicationDate() {
        return getProperty("kittyshippoproject:publicationdate");
    }
}

...
@Node(jcrType = "kittyshippoproject:author")
public class Author extends HippoDocument implements AuthorEntry {

    public static final String ROLE = "kittyshippoproject:role";
    public static final String ACCOUNTS = "kittyshippoproject:accounts";
    public static final String FULL_NAME = "kittyshippoproject:fullname";
    public static final String IMAGE = "kittyshippoproject:image";
    public static final String CONTENT = "kittyshippoproject:content";

    @HippoEssentialsGenerated(internalName = "kittyshippoproject:fullname")
    ...
    @HippoEssentialsGenerated(internalName = "kittyshippoproject:role")
    ...
    public HippoGalleryImage getImage() {
  	...
  	@HippoEssentialsGenerated(internalName = "kittyshippoproject:accounts")
